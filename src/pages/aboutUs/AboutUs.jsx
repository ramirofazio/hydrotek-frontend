...
export function AboutUs() {
  return (
    <main className="mb-12 grid place-items-center gap-6 p-8 xl:mb-0 xl:flex xl:p-20 xl:pt-0">
      <section className="grid gap-6 xl:relative xl:flex-1 xl:p-20 xl:pb-10">
        ...
        <p className="sm:text-sm xl:text-lg">{t("about.content")}</p>
        <p className="sm:text-sm xl:text-lg">{t("about.content2")}</p>
